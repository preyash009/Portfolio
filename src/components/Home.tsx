      ...
      <div className="container mx-auto px-6 relative z-10" ref={ref}>
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <h1 className="text-xl sm:text-2xl md:text-3xl text-gray-300 mb-4">Hi There! <span className="inline-block animate-wave">👋🏻</span></h1>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-6 mb-8 sm:mb-10 md:mb-12 px-4"
          >
            <a 
              href="#" 
              className="glass-morphism px-6 sm:px-8 py-3 sm:py-4 rounded-full hover:scale-105 transition-all duration-300 flex items-center justify-center gap-3 group w-full sm:w-auto"
            >
