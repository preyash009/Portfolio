...
const projects = [
  ...
  },
  {
    ...
    tech: ["Laravel", "MySQL", "API", "Payment Gateway Integration"],
    github: "",
  ...
  {
    title: "Propertia",
    description: "Propertia delivers expert real estate services in Bali, specializing in luxury villas, beachfront properties, investment opportunities, and dream homes.",
    tech: ["PHP", "MySQL", "REST API", "Maps"],
    github: "",
    live: "https://propertia.com/",
    image: "/images/projects/propertia.webp",
    stars: 0,
    forks: 0,
    featured: false,
  },
